...
aΓ((u,λ0,λ1,λ2,λ3),(v,μ0,μ1,μ2,μ3)) = ∫( λ0*(ctˣ(z_cf,0)*v⋅n_Γ) + μ0*(ctˣ(z_cf,0)*u⋅n_Γ) +
                                         λ1*(ctˣ(z_cf,1)*v⋅n_Γ) + μ1*(ctˣ(z_cf,1)*u⋅n_Γ) +
                                         λ2*(ctˣ(z_cf,2)*v⋅n_Γ) + μ2*(ctˣ(z_cf,2)*u⋅n_Γ) +
                                         λ3*(ctˣ(z_cf,3)*v⋅n_Γ) + μ3*(ctˣ(z_cf,3)*u⋅n_Γ) )*dΓ

a((u,λ0,λ1,λ2,λ3),(v,μ0,μ1,μ2,μ3)) =  aΩ((u,λ0,λ1,λ2,λ3),(v,μ0,μ1,μ2,μ3)) + 
                                      aΓ((u,λ0,λ1,λ2,λ3),(v,μ0,μ1,μ2,μ3))


l((v,μ0,μ1,μ2,μ3)) = ∫(v⋅f)*dΩ + ∫(μ0*g0 + μ1*g1 + μ2*g2 + μ3*g3)*dΓ
