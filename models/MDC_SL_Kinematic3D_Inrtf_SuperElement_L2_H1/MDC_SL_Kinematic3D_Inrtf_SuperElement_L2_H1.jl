...
prblName = "MDC_SL_Kinematic3D_Inrtf_SuperElement_L2_H1"
projFldr = pwd()
...
reffe_L2 = ReferenceFE(lagrangian,VectorValue{dofs,Float64},0)
Vλ_L2 = FESpace(Γc,reffe_L2;conformity=:L2)
Uλ_L2 = TrialFESpace(Vλ_L2)

reffe_H1 = ReferenceFE(lagrangian,VectorValue{dofs,Float64},(2,0))
Vλ_H1 = FESpace(Γc,reffe_H1)
Uλ_H1 = TrialFESpace(Vλ_H1)

# Ajuntem els dos espais anteriors
V = MultiFieldFESpace([Vu,Vλ_H1,Vλ_L2])
U = MultiFieldFESpace([Uu,Uλ_H1,Uλ_L2])
...
aΩ((u,λ_L2,λ_H1),(v,μ_L2,μ_H1)) = ∫( ∂(v)⊙σ(CTf[1],∂(u)) )*dΩ
aΓ_L2((u,λ_L2,λ_H1),(v,μ_L2,μ_H1)) = func(prob,u,v,λ_L2,μ_L2)
aΓ_H1((u,λ_L2,λ_H1),(v,μ_L2,μ_H1)) = func(prob,u,v,λ_H1,μ_H1)

a((u,λ_L2,λ_H1),(v,μ_L2,μ_H1)) =  aΩ((u,λ_L2,λ_H1),(v,μ_L2,μ_H1)) + 
                                  aΓ_L2((u,λ_L2,λ_H1),(v,μ_L2,μ_H1)) + 
                                  aΓ_H1((u,λ_L2,λ_H1),(v,μ_L2,μ_H1))
